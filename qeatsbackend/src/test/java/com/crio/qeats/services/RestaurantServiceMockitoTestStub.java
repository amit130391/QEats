...
public class RestaurantServiceMockitoTestStub {
  ...
  public void initializeRestaurantObjects() throws IOException {
    ...
    restaurant1=restaurants[0];//restaurantId:11
    restaurant2=restaurants[1];//restaurantId:12 
    restaurant3=restaurants[2];//restaurantId:13
    restaurant4=restaurants[3];//restaurantId:14
    restaurant5=restaurants[4];//restaurantId:15
  }
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    lenient().doReturn(restaurantList2)
        .when(restaurantRepositoryServiceMock)
        .findAllRestaurantsCloseBy(any(Double.class), any(Double.class), eq(LocalTime.of(19, 0)),
            eq(3.0));
