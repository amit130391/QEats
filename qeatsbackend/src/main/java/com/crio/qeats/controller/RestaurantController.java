...
public class RestaurantController {
  ...
  public ResponseEntity<GetRestaurantsResponse> getRestaurants(
       @Valid @ModelAttribute GetRestaurantsRequest getRestaurantsRequest,BindingResult bindingResult) {
    ...
    //     return (ResponseEntity<GetRestaurantsResponse>) ResponseEntity.badRequest();
    // }
